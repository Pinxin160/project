...
class ChessGame_2p:
    def __init__(self, root, piece_ranks, user_file, second_user_file=None):
        ...
        self.second_user_ori_score = user_file['score']
    ...
    def check_game_over(self):
        ...
        self.game_over = True
        self.user_file['score'] = self.user_ori_score + player_score1
        self.second_user_file['score'] = self.second_user_ori_score + player_score2
        messagebox.showinfo("遊戲結束", message)
